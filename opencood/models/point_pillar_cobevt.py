...
class PointPillarCoBEVT(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        _, _, H0, W0 = batch_dict['spatial_features'].shape # original feature map shape
        ...
        B, L = t_matrix.shape[:2] # B=1, L=5
        
        # N, C, H, W -> B,  L, C, H, W (regroup_feature[1, 5, 256, 48, 176])
        ...
        for b in range(B):
            ego = 0
            regroup_feature_new.append(warp_affine_simple(regroup_feature[b], t_matrix[b, ego], (H, W)))
